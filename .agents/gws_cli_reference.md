...
[![npm version](https://img.shields.io/npm/v/@googleworkspace/cli)](https://www.npmjs.com/package/@googleworkspace/cli)
[![license](https://img.shields.io/github/license/googleworkspace/cli)](https://github.com/googleworkspace/cli/blob/main/LICENSE)
[![CI status](https://img.shields.io/github/actions/workflow/status/googleworkspace/cli/ci.yml?branch=main&label=CI)](https://github.com/googleworkspace/cli/actions/workflows/ci.yml)
[![install size](https://img.shields.io/npm/unpacked-size/@googleworkspace/cli)](https://www.npmjs.com/package/@googleworkspace/cli)
